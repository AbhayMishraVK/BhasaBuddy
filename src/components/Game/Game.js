...
const handleNextClick = () => {
  ...
  // Check if the user has played 5 rounds
  if (roundCounter === 4) {
    setShowScore(true);
  } else {
  ...
  return (
    <div className="con">
       ...
       <img src="/fun.gif" alt="Fun GIF" style={{ width: '300px', height: 'auto', position: 'fixed', bottom: '10px', left: '10px' }} />
...
< PlayMoreButton/>
   <img src="/fun.gif" alt="Fun GIF" style={{ width: '300px', height: 'auto', position: 'fixed', bottom: '10px', right: '10px' }} />
</div>
);
}
